...
## A Python bug from 2002 to 2013

`list.sort()` is **Timsort**. 

There was an undetected bug in its run-merging logic.

- **2015:** de Gouw et al. tried to *prove* it correct with the KeY
  theorem prover but failed^[S. de Gouw et al., OpenJDK's `sort()` is broken, CAV 2015]
