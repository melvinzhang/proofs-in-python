...
- **Python 3.11:** the merge policy is replaced with **Powersort**^[J. I. Munro & S. Wild, [*Nearly-Optimal Mergesorts*](https://www.wild-inter.net/publications/munro-wild-2018), ESA 2018.]
...
mathesis builds a natural-deduction proof, one justified step per line:
...
pyzar is a tactic-style prover on a tiny HOL kernel — you write the proof as justified steps, just like a textbook:
